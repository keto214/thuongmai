	...
	<div class="container">
		<div class="row inner">
			<div class="col-md-2 logo">
				<a href="index.php"><img class="logo_height" src="assets/uploads/<?php echo $logo; ?>" alt="logo image"></a>
			</div>
			<div class="col-md-5 search-area">
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					...
					<button type="submit" class="btn btn-primary"><?php echo LANG_VALUE_3; ?></button>
				</form>
			</div>
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						...
						<li>
							<div class="dropdown">
								<button class="btn1 btn-secondary dropdown-toggle" style="font-size:18px; border: 0px solid transparent; background: white;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<i class="fa fa-user"></i> <?php echo LANG_VALUE_13; ?> <?php echo $_SESSION['customer']['cust_name']; ?>
								</button>
								<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									<div><a href="dashboard.php"><i class="fa fa-home"></i> <?php echo LANG_VALUE_89; ?></a></div>
									<div><a href="logout.php"><i class="fa fa-arrow-right"></i>Đăng xuất</a></div>
								</div>
							</div>
						</li>
						<?php
						...
						<li>
							<div class="dropdown">
								<button class="btn1 btn-secondary dropdown-toggle" style="font-size:18px; border: 0px solid transparent; background: white;" type="button" id="dropdownMenuButton" data-toggle="dropdown" >
									Sign Up / Sign In
								</button>
								<div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
									<div>
										<a href="login.php"><i class="fa fa-sign-in"></i> <?php echo LANG_VALUE_9; ?></a>
									</div>
									<div>
										<a href="registration.php"><i class="fa fa-user-plus"></i> <?php echo LANG_VALUE_15; ?></a>
									</div>
								</div>
							</div>
					...
					<li style="bottom-top:10px"><a href="cart.php"><i class="fa fa-shopping-cart"></i> <?php echo LANG_VALUE_18; ?> (<?php
