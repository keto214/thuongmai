	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">Laptop Pro</span>
			</a>
			...
			<nav class="navbar navbar-static-top">
				...
				<span style="float:left;line-height:50px;color:#fff;padding-left:15px;font-size:18px;">Quản lý của Admin</span>
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								<li class="user-footer">
									<div>
										<a href="profile-edit.php" class="btn btn-default btn-flat">Chỉnh sửa thông tin</a>
									</div>
									<div>
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'size.php') || ($cur_page == 'size-add.php') || ($cur_page == 'size-edit.php') || ($cur_page == 'color.php') || ($cur_page == 'color-add.php') || ($cur_page == 'color-edit.php') || ($cur_page == 'country.php') || ($cur_page == 'country-add.php') || ($cur_page == 'country-edit.php') || ($cur_page == 'shipping-cost.php') || ($cur_page == 'shipping-cost-edit.php') || ($cur_page == 'top-category.php') || ($cur_page == 'top-category-add.php') || ($cur_page == 'top-category-edit.php') || ($cur_page == 'mid-category.php') || ($cur_page == 'mid-category-add.php') || ($cur_page == 'mid-category-edit.php') || ($cur_page == 'end-category.php') || ($cur_page == 'end-category-add.php') || ($cur_page == 'end-category-edit.php') ) {echo 'active';} ?>">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="size.php"><i class="fa fa-circle-o"></i> Dung lượng</a></li>
                            <li><a href="color.php"><i class="fa fa-circle-o"></i> Màu sắc</a></li>
                            <li><a href="country.php"><i class="fa fa-circle-o"></i> Địa phương</a></li>
                            <li><a href="shipping-cost.php"><i class="fa fa-circle-o"></i> Phí giao hàng</a></li>
                            <li><a href="top-category.php"><i class="fa fa-circle-o"></i> Danh mục cao thứ 1</a></li>
                            <li><a href="mid-category.php"><i class="fa fa-circle-o"></i> Danh mục cao thứ 2</a></li>
                            <li><a href="end-category.php"><i class="fa fa-circle-o"></i> Danh mục cao thứ 3</a></li>
                        </ul>
                    </li>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'service.php') ) {echo 'active';} ?>">
			          ...
			          <a href="customer.php">
			            <i class="fa fa-user-plus"></i> <span>Quản lý tài khoản đăng ký</span>
			          </a>
			        </li>

			        <li class="treeview <?php if( ($cur_page == 'page.php') ) {echo 'active';} ?>">
			          <a href="page.php">
			            <i class="fa fa-tasks"></i> <span>Quản lý nội dung </span>
			          </a>
			        </li>

			        <li class="treeview <?php if( ($cur_page == 'social-media.php') ) {echo 'active';} ?>">
			          <a href="social-media.php">
			            <i class="fa fa-globe"></i> <span>Kênh truyền thông</span>
			          </a>
			        </li>

			        <li class="treeview <?php if( ($cur_page == 'subscriber.php')||($cur_page == 'subscriber.php') ) {echo 'active';} ?>">
			          <a href="subscriber.php">
			            <i class="fa fa-hand-o-right"></i> <span>Khách hàng đăng ký</span>
			          </a>
			        </li>
